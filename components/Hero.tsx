...
const features = [
  {
    icon: ThermometerSun,
    text: 'Perfect klimaat in historisch Maastricht',
  },
  {
    icon: Zap,
    text: 'Energiezuinige oplossingen',
  },
  {
    icon: Euro,
    text: 'Lokale subsidies mogelijk',
  },
];
          ...
          >
            <div className="inline-block px-4 py-2 bg-blue-500/20 rounded-full mb-6">
              <span className="text-blue-200 font-medium">
                Dé Airco Specialist in Maastricht & Omgeving
              </span>
            </div>
            <h1 className="text-5xl lg:text-7xl font-bold mb-6 leading-tight">
              Klimaatcomfort voor{' '}
              <span className="text-blue-400">Historisch Maastricht</span>
            </h1>
            <p className="text-xl mb-8 text-blue-100">
              Geniet van het beste van beide werelden: moderne klimaatbeheersing in uw karakteristieke Maastrichtse woning. 
              Speciaal afgestemd op de unieke architectuur van Maastricht.
            </p>
          ...
          >
            <div className="relative">
              ...
              <img
                ...
                alt="Moderne airconditioning in Maastricht"
