export default function Schema() {
  const schema = {
    ...
    description: 'Specialist in energiezuinige airconditioning installatie in Maastricht. Verwarmen & koelen met één systeem, ideaal in combinatie met zonnepanelen.',
    image: 'https://images.unsplash.com/photo-1631545806609-35d4ae440431?auto=format&fit=crop&q=80',
    '@id': 'https://aircoinstallatie-maastricht.nl',
